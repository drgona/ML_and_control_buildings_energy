...
Solver: matrix exponential using Jacobian linearization at the initial conditions
ODE: two-tank system
...
# Compute Jacobian matrix at the initial point
A = jacobian_matrix( h0[0],  h0[1])
